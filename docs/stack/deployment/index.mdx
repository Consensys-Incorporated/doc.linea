...
See [Trust and responsibilities](../evaluate/trust-model.mdx) for what each deployment model
trusts, what the operator-run path can do, and what participants can verify.
