...
It limits who can use the operator's RPC, but it does not hide chain data from the
...
<GlossaryTerm term="Finalization layer">finalization layer</GlossaryTerm>. The endpoint restricts who
can use the operator's RPC. It does not hide data that is already onchain.
A <GlossaryTerm term="Validium">private validium</GlossaryTerm> keeps transaction data offchain. The
