...
They can also read submission events, contract role assignments, contract state, proxy admin,
...
- **Data availability (DA) withheld in a private validium**: Participants without the required DA or
  [access control](../deployment/rbac.mdx) permissions cannot reconstruct or verify affected private data.
