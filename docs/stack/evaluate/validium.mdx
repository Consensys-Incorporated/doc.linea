...
selected finalization layer, are on
[Trust and responsibilities](./trust-model.mdx#what-participants-can-verify).
...
- Review [trust and responsibilities](./trust-model.mdx#what-participants-can-verify)
