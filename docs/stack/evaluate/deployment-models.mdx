...
- [Data availability](../deployment/data-availability.mdx) guarantees: How important is onchain data availability for
  your participants?
...
- [Data availability](../deployment/data-availability.mdx): Where transaction
  data is stored in each deployment model
